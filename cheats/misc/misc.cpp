...
#else
#define VERSION crypt_str("Kitsune | ")
#endif
#else
...
void misc::ChatSpamer()
{
	...
	{ 
		crypt_str("Kitsunesquad.online - stay with us or lose the game."),
		crypt_str("Get good. Get kitsunesquad.online."),
		crypt_str("Kitsunesquad.online - just the best."),
		crypt_str("Go to another level with kitsunesquad.online."),
	};
